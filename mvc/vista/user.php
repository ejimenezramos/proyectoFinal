...
<body>
    ...
    </div><?php $val = Validacion::getInstance(); ?>
    <div class="header">
                ...
                <nav class="navbar navbar-default">
                    ...
                    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                        <ul class="nav navbar-nav ">
                            <li>
                                <a href="?pagina=home" class="hyper ">
                                    <span>Home</span>
                                </a>
                            </li>
                            <li>
                                <a href="?pagina=productos" class="hyper">
                                    <span>Productos</span>
                                </a>
                            </li>
                            <li>
                                <a href="?pagina=packs" class="hyper">
                                    <span>
                                        Packs
                                        especiales
                                    </span>
                            ...
                            <li>
                                <a href="?pagina=aboutus" class="hyper">
                                    <span>
                                        Sobre
                                        nosotros
                                    </span>
                            ...
                            <li>
                                <a href="?pagina=contact" class="hyper">
            ...
            <div class="main-agileits">
                <div class="form-w3agile form1">
                    ...
                    <form action="index.php?pagina=user" method="post" id="modificacion">
                        ...
                        <label class="{{class-Telefono}}" for="telefono">Tel茅fono</label>
                        <div class="key">
                            <i class="fa fa-mobile-phone" aria-hidden="true"></i>
                            <input type="text" placeholder="Tel茅fono" name="Telefono" id="telefono" maxlength="9"
                                   oninvalid="setCustomValidity('Todos los campos son obligatorios para el registro')"
                        ...
                        <label class="{{class-Direccion}}" for="Direccion">Direcci贸n</label>
                        <div class="key">
                            <i class="fa fa-home" aria-hidden="true"></i>
                            <input type="text" placeholder="Direcci贸n" name="Direccion" id="direccionCompleta"
                                   oninvalid="setCustomValidity('Todos los campos son obligatorios para el registro')"
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">
                                Pol&iacute;tica de devoluci&oacute;n de
                                productos
                            </h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <ol>
                                <li class="list-group-item1">
                                    El usuario o cliente dispone de siete
                                    ...
                                    est&eacute; en perfectas condiciones
                                </li>
                                <li class="list-group-item1">
                                    Conservar el envoltorio original si
                                    &eacute;ste est&aacute; abierto no se podr&aacute; proceder al
                                    cambio o devoluci&oacute;n.
                                </li>
                                <li class="list-group-item1">
                                    Es requisito imprescindible que tanto
                                    ...
                                    menoscabo del producto, en especial la apertura del recipiente.
                                </li>
                                <li class="list-group-item1">
                                    Cualquier producto abierto, cortado o
                                    manipulado de cualquier manera no podr&aacute; ser sujeto a
                                    cambio o devoluci&oacute;n.
                                </li>
                                <li class="list-group-item1">
                                    El pedido devuelto deber&aacute; ser
                                    ...
                                    el caso y se proceda al cambio o devoluci&oacute;n.
                                </li>
                            </ol>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="wpb_wrapper">
                                ...
                                <p>
                                    <span>
                                        Realizamos todos nuestros pedidos en las 48h tras el pedido
                                ...
                                <p>
                                    <span>
                                        Las <strong>TARIFAS DE ENV&#205;O</strong>&nbsp;van desde <strong>3,05&#8364;</strong>&nbsp;dependiendo
                                ...
                                <p>
                                    <span>
                                        1. Las presentes condiciones ser&aacute;n de
                                        ...
                                        singularidad de cada producto o servicio.
                                    </span>
                                </p>
                                <p>
                                    <span>
                                        2. Los datos sobre el destino del pedido y para el
                                ...
                                <p>
                                    <span>
                                        3. La prestaci&oacute;n de los servicios se
                                ...
                                <p>
                                    <span>
                                        4. En caso de incumplimiento del plazo de entrega
                                        ...
                                        cliente el 100% del valor del pedido.
                                    </span>
                                </p>
                                <p>
                                    <span>
                                        5. La entrega del pedido se realizar&aacute; en el
                                        ...
                                        entrega, as&iacute; como de la forma de acordar la misma.
                                    </span>
                                </p>
                                <p>
                                    <span>
                                        6. Ser&aacute; requisito necesario para proceder a la
                                ...
                                <p>
                                    <span>
                                        7. Los plazos para efectuar la reclamaci&oacute;n por
