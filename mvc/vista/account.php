...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-xs-6 thumb">
				<a class="thumbnail" data-toggle="modal" data-target="#myModal23"> <img
						class="img-responsive" src="images/user.jpg" alt="">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-4 col-xs-6 thumb">
					<a href="?pagina=user"><h4>Modifica tus datos personales</h4>
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-xs-6 thumb">
				<a href="?pagina=historial"><h4>Historial</h4></a>
