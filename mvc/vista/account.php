...
<html>
<head>
    <title>Cereal-Break | Mi Cuenta</title>
    <!-- for-mobile-apps -->
...
<div class="banner-top">
    <div class="container">
        <h3>Mi Cuenta</h3>
        <h4>
            <a href="?pagina=home">Home</a><label>/</label>Mi cuenta
        </h4>
        <div class="clearfix"></div>
    </div>
</div>
...
<div class="container">
    <div class="row center" style="margin-top: 4%">
        ...
        <div class="col-lg-6 col-md-6 col-xs-12 thumb">
            <a  class="btn btn-danger my-cart-b" href="?pagina=historial"><h3>Historial</h3></a></div>
