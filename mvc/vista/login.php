...
<body>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li><a href="?pagina=contact" class="hyper"><span>Cont谩ctanos</span></a></li>
						</ul>
					</div>
				</nav>
				<div class="cart">
	...
	<div class="login">
		...
		<div class="main-agileits">
				...
				<form action="index.php?pagina=login" method="post" id="formLogin">
					<div class="key">
						<i class="fa fa-user" aria-hidden="true"></i> <input type="text"
							...
							oninvalid="setCustomValidity('Para iniciar sesi贸n debe rellenar ambos campos')"
			...
			<div class="forg">
				<a href="?pagina=olvido" class="forg-left">Olvid茅 la contrase帽a</a>
