			...
			<div class=" con-w3l agileinf">
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							...
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Cheerios</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
										<label>4,00€</label><em class="item_price">3,00€</em>
									</p>
									<div class="block">
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							...
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Reese´s Puffs</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
								...
								<div class="add">
									<button class="btn btn-danger my-cart-btn my-cart-b"
										data-id="25" data-name="Cocoa Puffs" data-summary="summary 25"
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							...
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Cinnamon Crunch</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							...
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Lucky Charms</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
								...
								<div class="add">
									<button class="btn btn-danger my-cart-btn my-cart-b"
										data-id="28" data-name="BoxLuxky" data-summary="summary 28"
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							...
							<div class="mid-1">
								...
								<div class="add">
									<button class="btn btn-danger my-cart-btn my-cart-b"
										data-id="29" data-name="BoxTrix" data-summary="summary 29"
										data-price="4.50" data-quantity="1"
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							...
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Cocoa Puffs</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
								...
								<div class="add">
									<button class="btn btn-danger my-cart-btn my-cart-b"
										data-id="30" data-name="BoxCocoa" data-summary="summary 30"
										data-price="3.50" data-quantity="1"
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							...
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Leche Azul</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal" data-target="#myModal9"
								class="offer-img"> <img src="images/milkpink.png"
								class="img-responsive" alt="">
							</a>
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Leche Rosa</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal" data-target="#myModal10"
								class="offer-img"> <img src="images/milkgreen.png"
								class="img-responsive" alt="">
							</a>
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Leche Verde</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal" data-target="#myModal11"
								class="offer-img"> <img src="images/milkvainilla.png"
								class="img-responsive" alt="">
							</a>
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Leche de Vainilla</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal" data-target="#myModal12"
								class="offer-img"> <img src="images/milksojaalmond.png"
								class="img-responsive" alt="">
							</a>
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Leche de Soja y Almendras</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
								...
								<div class="add">
									<button class="btn btn-danger my-cart-btn my-cart-b"
										data-id="35" data-name="Leche de Soja y Almendras" data-summary="summary 35"
										data-price="0.80" data-quantity="1"
				...
				<div id="toppings">
					<div class="col-md-3 pro-1">
						<div class="col-m">
							...
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Kinder Bueno</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
								...
								<div class="add">
									<button class="btn btn-danger my-cart-btn my-cart-b"
											data-id="35" data-name="Kinder Bueno" data-summary="summary 35"
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal" data-target="#myModal12"
							   class="offer-img"> <img src="images/packchips.png"
													   class="img-responsive" alt="">
							</a>
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Chips Ahoy!</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
								...
								<div class="add">
									<button class="btn btn-danger my-cart-btn my-cart-b"
											data-id="35" data-name="Chips Ahoy!" data-summary="summary 35"
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							...
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Kinder Schoko-Bons</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal" data-target="#myModal12"
							   class="offer-img"> <img src="images/packoreo.png"
													   class="img-responsive" alt="">
							</a>
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Oreo</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
										<label>2.20€</label><em class="item_price">1.80€</em>
									</p>
									<div class="block">
					...
					<div class="col-md-3 pro-1">
						<div class="col-m">
							<a href="#" data-toggle="modal" data-target="#myModal12"
							   class="offer-img"> <img src="images/packconguitos.png"
													   class="img-responsive" alt="">
							</a>
							<div class="mid-1">
								<div class="women">
									<h6>
										<a href="single.html">Conguitos</a>
									</h6>
								</div>
								<div class="mid-2">
									<p>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="copy-right">
				<p>
					&copy; 2017 Big store. All Rights Reserved | Design by <a
