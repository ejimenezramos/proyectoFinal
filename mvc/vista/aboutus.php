...
<html>
<head>
<title>Cereal | Break - Sobre Nosotros -</title>
<!-- for-mobile-apps -->
...
<body>
	...
	<div class="container">
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-8">
					...
					<h2>ORIGEN</h2>
					<br>
					<p>La idea de formar Cereal-Break, nace de la necesidad de los
						consumidores nacionales de probar otro tipo de productos que no
						son habituales de nuestro país. Por este motivo se decide en el
						año 2016, importar los primeros cereales americanos para su
						posterior venta en España. Ante la buena respuesta del consumidor
						nacional, se decide ampliar el negocio y nuestra oferta de
						productos hasta que finalmente se incorpora en el año 2017 la
						leche coloreada o "colored milk", que ya había sido un éxito en
						otros paises.</p>
					<br>

				</div>
				<div class="col-sm-4">
					<img class="img-responsive" src="images/ideas-icon.png" alt="">
				</div>
			</div>
		</div>
		...
		<div class="container-fluid bg-grey">
			<div class="row">
				<div class="col-sm-4">
					<img class="img-responsive" src="images/objetive.png" alt="">
				</div>
				<div class="col-sm-8">
					<h2>NUESTROS VALORES</h2>
					<br>
					<h4>Objetivos</h4>
					<p>Actualmente, contamos con más de 50.000 clientes suscritos a
						nuestra web que realizan compras asiduamente y disfrutan de
						nuestros productos. El objetivo para este año 2017 es llegar a
						los 100.000 clientes, por este motivo, seguiremos ampliando
						nuestra oferta con los productos más novedosos del mercado.</p>
					<br>
					<h4>Visi&oacute;n</h4>
					<p>Todos nuestros productos pasan por un exhaustivo control de
						calidad que garantiza su calidad y autenticidad. Desde
						Cereal-Break nos preocupamos porque los productos que ofertamos
						cumplan todos los requisitos necesarios para alcanzar los máximos
						niveles de calidad exigidos a nivel nacional</p>
					<br>
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="row-fluid">
						<div class="span8">
							<iframe
								src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7259.8043598369095!2d-3.6953181103974777!3d40.427837652628575!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd4228916c1c7eab%3A0x98e9633fb39f8d43!2sPaseo+de+la+Castellana%2C+10%2C+28046+Madrid!5e0!3m2!1ses!2ses!4v1496854637819"
