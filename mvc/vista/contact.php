			...
			<div class="form-w3agile">
				...
				<form action="#" method="post" id="registro">
					<div class="key">
						...
						<input  type="text" placeholder="Nombre" name="nombre" id="nombre" maxlength="20" oninvalid="setCustomValidity('Todos los campos son obligatorios para enviar el formulario de contacto'')">
						<div class="clearfix"></div>
					</div>
					<div class="has-warning"><p id="errornombre"></p></div>
					<div class="key">
						<i class="fa fa-user" aria-hidden="true"></i>
						<input  type="text" placeholder="Apellidos" name="apellidos" id="apellidos" maxlength="20" oninvalid="setCustomValidity('Todos los campos son obligatorios para enviar el formulario de contacto'')">
						<div class="clearfix"></div>
					</div>
					<div class="has-warning"><p id="errorapellidos"></p></div>
					<div class="key">
						<i class="fa fa-envelope" aria-hidden="true"></i>
						<input  type="text" placeholder="email@example.com" name="email" id="email" oninvalid="setCustomValidity('Todos los campos son obligatorios para enviar el formulario de contacto'')">
						<div class="clearfix"></div>
					</div>
					<div class="has-warning"><p id="erroremail"></p></div>
					<div class="key">
						<i class="fa fa-list" aria-hidden="true"></i>
						<select class="consulta" name="consulta" id="consulta" oninvalid="setCustomValidity('Todos los campos son obligatorios para enviar el formulario de contacto')">
