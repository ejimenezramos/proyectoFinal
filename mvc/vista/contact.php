				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class="active"><a href="?pagina=contact" class="hyper"><span>Cont谩ctanos</span></a></li>
						</ul>
					</div>
				</nav>
				<div class="cart">
				...
				<form action="index.php?pagina=contact" method="post" id="contacto">
					...
					<div class="key">
						<i class="fa fa-list" aria-hidden="true"></i> <select
							class="consulta" name="Consulta" id="consulta">
							<option value="0">--Selecciona una consulta--</option>
							<option value="1">Informaci贸n general</option>
					...
					<div class="has-warning">
						<p id="errorconsulta"></p>
					</div>
					<div class="key">
						<i class="fa fa-comments" aria-hidden="true"></i>
						<textarea cols="50" rows="10"
							placeholder="Escribe aqu铆 tu comentario" name="area" id="area"></textarea>
						<div class="clearfix"></div>
					</div>
					<div class="has-warning">
						<p id="errorarea"></p>
					</div>
					<input type="submit" value="Contactar" name="contact"
						id="contactar">
					<div class="has-warning">
						<p id="errorsubmit"></p>
					</div>
