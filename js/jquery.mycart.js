    ...
    var loadMyCartEvent = function (userOptions) {
        ...
        if (!$("#" + idCartModal).length) {
            $('body').append(
                ...
                '<h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-shopping-cart"></span> My carro</h4>' +
                '</div>' +
                '<div class="modal-body">' +
                '<table class="table table-hover table-responsive" id="' + idCartTable + '"></table>' +
                '</div>' +
                '<div class="modal-footer">' +
                '<input type="button" class="btn btn-default" value="Cerrar" data-dismiss="modal">' +
        ...
        var drawTable = function () {
           ...
           var productos=prods.substr(0,prods.length-1);
            ...
            $cartTable.append(products.length ?
                ...
                '<td></td>' +
                '</tr>'
                    : '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">El carrito está vacío</div>'
            );
